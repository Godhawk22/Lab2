...
int main()
{
    ...
    // Заполняем массивы данными (убывающая последовательность)
    ...
    // Выводим результаты
    printf("Сортировка Шелла (убывающая): %f секунд\n", shell_time);
    printf("Быстрая сортировка (убывающая): %f секунд\n", quicksort_time);
    printf("Сортировка qsort (убывающая): %f секунд\n", qsort_time);
